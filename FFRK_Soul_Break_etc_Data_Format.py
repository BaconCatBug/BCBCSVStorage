...
df_export = df_export.drop('Source Type', axis=1)
...
df_import = read_csv(url, dtype=str)
selected_columns = df_import[['Common Name','Effects','Default Duration','MND Modifier','Exclusive Status','ID','Notes']]
df_export = selected_columns.copy()
df_export = df_export[df_export['Notes'] == '-']
df_export = df_export.drop('Notes', axis=1)
